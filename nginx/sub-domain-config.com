...
server {
    ...
    # SSL configuration
    ssl_certificate /etc/letsencrypt/live/auto.wibudev.com/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/auto.wibudev.com/privkey.pem;
